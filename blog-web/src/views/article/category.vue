<template>
                ...
                <el-table-column label="操作" width="120">
                    <template #default="{ row, $index }">
                        ...
                        <el-button v-if="row.isDel === 0" circle plain type="danger"
                            @click="onDelCategory(row.id, $index)"><el-icon>
                                <Delete />
                            </el-icon></el-button>
                    </template>
                </el-table-column>
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" :lockScroll="false" width="500" center class="addCategory">
