<template>
  ...
  <page-container title="友链管理">
    ...
    <div class="table-wrapper">
      <el-table v-loading="loading" :data="friendList" style="width: 100%" class="table"
        ...
        <el-table-column label="网页封面" width="200">
        ...
        <el-table-column label="操作" width="120">
          <template #default="{ row, $index }">
            ...
            <el-button v-if="row.state !== 1" circle plain type="danger" @click="onDelFriend(row.id, $index)"><el-icon>
                <Delete />
              </el-icon></el-button>
          </template>
        </el-table-column>
  ...
  <el-dialog v-model="dialogVisible" title="添加友链" :lockScroll="false" width="500" center class="addCategory">
